...
function render(g) {
  ...
  m.drawRing(170, 185, m.leafSegment, {
    count: 40,
    hidePerimeter: true,
    angleShift: 0.5,
    insetA: 0.22,
  ...
  const leafCount = 72;
  m.drawRing(220, 240, m.leafTiltedSegment, {
    count: leafCount,
    skipFactor: 2,
  });
  m.drawRing(240, 260, m.leafTiltedSegment, {
    count: leafCount,
    flip: true,
    skipFactor: 2,
  });
  ...
  m.drawRing(240, 240, m.circleSegment, {
    count: leafCount / 4,
    diameter: 10,
    angleShift: 0.5,
  });

  m.drawRing(260, 285, m.leafSegment, {
    count: leafCount / 4,
    diameter: 10,
    angleShift: 0.25,
    insetA: 0.25,
  ...
  m.drawRing(260, 295, m.leafSegment, {
    count: leafCount / 4,
    diameter: 10,
    angleShift: -0.25,
    insetA: 0.25,
