...
function renderInfo() {
  ...
  textSize(46);
  fill(theme.colors[1]);
  text(`Seattle Creative Coders`, margin, disp(60));;
  ...
  if (1) {
    fill(theme.colors[3]);
    textSize(40);
    text("Meetup and pop-up art show!", margin, disp(110) );
  }

  fill(200);
  textSize(40);
  text("Saturday, Mar 25, 7 - 10 pm", margin, (210));

  fill(theme.colors[2]);
  textSize(40);
  text("Studio at 2+U", margin, (300));
  text("1201 2nd Ave, Seattle", margin, (350));

  if (blink) {
    fill(theme.colors[1]);
    textSize(40);
    text("RSVP", margin, h - disp(220));
  }

  fill(theme.colors[3]);
  text("bit.ly/scc-mar25", margin, h - disp(160))

  textSize(30);
  fill(220)
  text("seattlecreativecode.com", margin, h - disp(60));
